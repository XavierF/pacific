...
function bones_scripts_and_styles() {
  ...
  if (!is_admin()) {
    ...
    wp_register_script( 'bones-doubletap-js', get_stylesheet_directory_uri() . '/library/js/dropdown-doubletap.js', array('jquery'), '', true);
    ...
    */
    ...
    wp_enqueue_script( 'bones-doubletap-js');
