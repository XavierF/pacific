...
################################################################################
  function bootstrapwp_css_loader() {
    wp_enqueue_style('bootstrapwp', get_template_directory_uri().'/css/less/bootstrapwp.css', false ,'0.90', 'all' );
    wp_enqueue_style('flexstyle', get_template_directory_uri().'/css/flexslider.css', false ,'1.0', 'all' );
...
################################################################################
  function bootstrapwp_js_loader() {
       ...
       wp_enqueue_script('demojs', get_template_directory_uri().'/js/jquery.flexslider-min.js', array('jquery'),'0.90', true );
  }
	...
	<li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
		<article id="comment-<?php comment_ID(); ?>" class="comment">
				<div class="comment-author vcard">
					...
					<p><?php printf( __( '%s <span class="says">:</span>', 'bootstrap' ), sprintf( '<cite class="fn">%s</cite>', get_comment_author_link() ) ); ?>
				<?php if ( $comment->comment_approved == '0' ) : ?>
					<em><?php _e( 'Your comment is awaiting moderation.', 'bootstrap' ); ?></em></p>
           ...
           <div class="comment-meta-data clearix">
